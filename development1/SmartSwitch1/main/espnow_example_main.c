...
static void example_espnow_task(void *pvParameter)
{
    ...
    ESP_LOGI(TAG, "Start sending broadcast data portMAX_DELAY %d, pdTRUE: %d",portMAX_DELAY ,pdTRUE);
    while (xQueueReceive(s_example_espnow_queue, &evt, portMAX_DELAY) == pdTRUE)
    {
        ...
        {
            ESP_LOGI(TAG, "Start sending broadcast data 3");
            example_espnow_event_send_cb_t *send_cb = &evt.info.send_cb;
            ...
            ESP_LOGI(TAG, "Start sending broadcast data 4");
        ...
        {
            ESP_LOGI(TAG, "Start sending broadcast data 5");
            example_espnow_event_recv_cb_t *recv_cb = &evt.info.recv_cb;
...
static esp_err_t example_espnow_init(bool mode)
{
    ...
    ESP_LOGE(TAG, "ESPNOW_QUEUE_SIZE: %d, sizeof(example_espnow_event_t) %d",ESPNOW_QUEUE_SIZE,sizeof(example_espnow_event_t));
